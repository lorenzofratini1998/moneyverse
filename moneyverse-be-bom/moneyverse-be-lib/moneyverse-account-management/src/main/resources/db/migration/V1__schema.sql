...
(
    ACCOUNT_CATEGORY_ID BIGINT PRIMARY KEY,
...
(
    ...
    CONSTRAINT FK_ACCOUNT_CATEGORY FOREIGN KEY (ACCOUNT_CATEGORY)
        REFERENCES ACCOUNT_CATEGORIES (ACCOUNT_CATEGORY_ID)
        ON DELETE RESTRICT
);
...
COMMENT
ON COLUMN ACCOUNTS.ACCOUNT_CATEGORY IS 'Reference to the Account Category.';
COMMENT
