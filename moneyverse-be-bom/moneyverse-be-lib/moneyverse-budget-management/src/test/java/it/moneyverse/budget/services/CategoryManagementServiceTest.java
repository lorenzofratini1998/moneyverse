...
class CategoryManagementServiceTest {
  ...
  void givenCategoryRequest_WhenCreateCategory_ThenReturnCreatedCategory(
    ...
    CategoryRequestDto request =
        CategoryTestFactory.CategoryRequestBuilder.builder().withUserId(userId).build();
  ...
  @Test
  void givenCategoryId_WhenDeleteCategory_ThenDeleteCategory(@Mock Category category) {
    UUID categoryId = RandomUtils.randomUUID();
