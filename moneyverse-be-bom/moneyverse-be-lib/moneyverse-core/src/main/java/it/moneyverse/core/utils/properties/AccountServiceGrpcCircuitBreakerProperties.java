...
import static it.moneyverse.core.utils.properties.AccountServiceGrpcClientProperties.ACCOUNT_SERVICE_CLIENT_PREFIX;

import org.springframework.boot.context.properties.ConfigurationProperties;
import org.springframework.boot.context.properties.bind.ConstructorBinding;

@ConfigurationProperties(prefix = AccountServiceGrpcCircuitBreakerProperties.PREFIX)
public class AccountServiceGrpcCircuitBreakerProperties {

  public static final String ACCOUNT_SERVICE_GRPC = "accountServiceGrpc";
  public static final String PREFIX = ACCOUNT_SERVICE_CLIENT_PREFIX + ".circuit-breaker";
  ...
  @ConstructorBinding
  public AccountServiceGrpcCircuitBreakerProperties(
