...
import static it.moneyverse.core.utils.properties.CurrencyServiceGrpcClientProperties.CURRENCY_SERVICE_CLIENT_PREFIX;

import org.springframework.boot.context.properties.ConfigurationProperties;
import org.springframework.boot.context.properties.bind.ConstructorBinding;

@ConfigurationProperties(prefix = CurrencyServiceGrpcCircuitBreakerProperties.PREFIX)
public class CurrencyServiceGrpcCircuitBreakerProperties {

  public static final String CURRENCY_SERVICE_GRPC = "currencyServiceGrpc";
  public static final String PREFIX = CURRENCY_SERVICE_CLIENT_PREFIX + ".circuit-breaker";
  ...
  @ConstructorBinding
  public CurrencyServiceGrpcCircuitBreakerProperties(
